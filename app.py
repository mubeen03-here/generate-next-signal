...
if st.session_state.get("selected_symbol"):
    ...
    if analysis:
        ...
        # ---- UPDATE OLD SIGNALS (HIGH/LOW CHECK ke saath) ----
        if db_initialized:
            update_old_signals(ticker, df_lower)  # <--- YAHAN df_lower pass karo
...
st.caption("⚡ Advanced System v3.1 | High/Low Backtest + Multi-TF + Failover + Alerts | Neon DB (Permanent) | Retry Enabled")
